...
const ProfileAndMenu = ({ screenWidth }) => {
    ...
    return (
        <div style={{ height:"20h", paddingLeft:`${screenWidth<778&&"15px"}`,paddingRight:`${screenWidth<778&&"15px"}` }} className={to == null ? ' hidden' : ` flex justify-between items-center w-full h-24 px-10`}>
