...
const MessageSection = () => {
    ...
    return (
        <div style={{height:`${screenWidth<778?"90h":"100vh"}`}} className= {screenWidth>778?" bg-slate-300 flex flex-col justify-between items-center w-9/12 ":" bg-slate-300 flex flex-col justify-between items-center w-screen "}>
