...
const MessageSection = () => {
    ...
    return (
        <div style={{height:"80vh"}} className= {screenWidth>778?" bg-slate-300 flex flex-col justify-between items-center w-9/12 ":" bg-slate-300 flex flex-col justify-between items-center w-screen "}>
