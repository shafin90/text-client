...
const FriendListSection = () => {
    ...
    return (
        <div className={screenWidth>576?"w-3/12 bg-gray-800 h-screen flex flex-col justify-between items-center":" w-screen bg-gray-800 h-screen flex flex-col justify-between items-center"}>
